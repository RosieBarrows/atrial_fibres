...
path="/data/Dropbox/Segmentations/2016111001EP/final_heart/LA_endo_fch/fibres_inc_uvc/"
fibres="/data/Dropbox/Segmentations/2016111001EP/final_heart/LA_endo_fch/fibres_inc_uvc/fibres_from_uvc"
sheets="/data/Dropbox/Segmentations/2016111001EP/final_heart/LA_endo_fch/fibres_inc_uvc/fibres_from_uvc_sheet"
...
la_fibres = np.concatenate((fibres_lon,sheets_lon),axis=1)
np.savetxt(path+'la_fibres.lon',la_fibres,fmt="%g",header='2',comments='')
